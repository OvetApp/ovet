            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  ...
                  <div className="grid grid-cols-1 gap-1">
                    <div
                      className={`flex items-center gap-1 ${password.length >= 8 ? "text-green-600" : "text-gray-500"}`}
                    >
                      {password.length >= 8 ? (
                    ...
                    <div
                      className={`flex items-center gap-1 ${/(?=.*[a-z])/.test(password) ? "text-green-600" : "text-gray-500"}`}
                    >
                      {/(?=.*[a-z])/.test(password) ? (
                        <Check className="h-3 w-3" />
                      ) : (
                    ...
                    <div
                      className={`flex items-center gap-1 ${/(?=.*\d)/.test(password) ? "text-green-600" : "text-gray-500"}`}
                    >
                      {/(?=.*\d)/.test(password) ? (
                        <Check className="h-3 w-3" />
                      ) : (
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  aria-describedby={
                    repeatPasswordError ? "repeat-password-error" : undefined
                  }
