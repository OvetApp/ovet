...
test.describe('Enhanced Authentication System', () => {
  test.describe('Authentication Routes', () => {
    ...
    test('should display forgot password page at /auth/forgot-password', async ({ page }) => {
    ...
    test('should display reset password page at /auth/reset-password', async ({ page }) => {
    ...
    test('should display email verification page at /auth/verify-email', async ({ page }) => {
  ...
  test.describe('Dashboard Routes - Protected', () => {
    ...
    test('should redirect unauthenticated users from /dashboard/billing to login', async ({ page }) => {
  ...
  test.describe('Onboarding Routes - Protected', () => {
    test('should redirect unauthenticated users from /onboarding/welcome to login', async ({ page }) => {
      await page.goto('/onboarding/welcome')
      
      await expect(page).toHaveURL(/.*\/auth\/login/)
    })

    test('should redirect unauthenticated users from /onboarding/profile-setup to login', async ({ page }) => {
      await page.goto('/onboarding/profile-setup')
      
      await expect(page).toHaveURL(/.*\/auth\/login/)
    })

    test('should redirect unauthenticated users from /onboarding/preferences to login', async ({ page }) => {
  ...
  test.describe('Middleware Logic', () => {
    test('should store return URL when redirecting unauthenticated users', async ({ page }) => {
      await page.goto('/dashboard/profile')
    ...
    test('should redirect authenticated users away from login/signup pages', async ({ page }) => {
  ...
  test.describe('Form Validation', () => {
    ...
    test('should validate password requirements on signup form', async ({ page }) => {
      await page.goto('/auth/signup')
  ...
  test.describe('Accessibility', () => {
    test('should have proper ARIA labels on auth forms', async ({ page }) => {
      ...
      await expect(page.getByRole('textbox', { name: /email/i })).toHaveAttribute('aria-label')
      await expect(page.getByRole('textbox', { name: /password/i })).toHaveAttribute('aria-label')
    })
